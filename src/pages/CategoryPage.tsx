      ...
      <div className="storage-list">
        <div className="page-head">
          ...
          {riskFilter && !backToDashboard && (
            <button className="btn small ghost" onClick={() => setRiskFilter(null)} title="清除风险筛选">
        ...
        <div className="results-head">
          ...
          <span className="results-count">
            {filtered.length} 项 · {formatBytes(totalBytes)}
            {selected.size > 0 && <> · 已勾选 {formatBytes(selectedBytes)} 占用</>}
          </span>
        </div>
